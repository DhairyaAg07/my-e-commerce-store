    ...
    if(imgXFile!=null)
    {
      ...
      //   1. Upload image to storage - get Download Url
        ...
        fStorage.Reference storageRef = fStorage.FirebaseStorage.instance
            .ref()
            .child("sellersBrandImages").child(fileName);
      ...
      //   2. save brandInfo to  firestore database
        saveBrandInfo();
      ...
      {
        Fluttertoast.showToast(msg: "Please Provide Brand Info and Brand Title");
      }
    }
    else
    {
