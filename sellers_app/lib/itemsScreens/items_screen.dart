        ...
        slivers: [
          ...
          StreamBuilder(
            stream: FirebaseFirestore.instance
                .collection("sellers")
                .doc(sharedPreferences!.getString("uid"))  // Retrieve sellerUid from sharedPreferences
                .collection("brands")
                .doc(widget.model!.brandID)  // Retrieve brandId from widget.model
                .collection("items")
                .orderBy("publishedDate", descending: true)
                .snapshots(),
            builder: (context, AsyncSnapshot dataSnapshot)
            {
              if(dataSnapshot.hasData) //if items exists
                  {
                //display items
